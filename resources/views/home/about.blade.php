...
<head>
    ...
    <title>About Us | PrimeAssetsTRD</title>
    ...
    <style>
        ...
        * {
        ...
        /* About Hero Section */
        .about-hero {
            background: linear-gradient(rgba(15, 28, 63, 0.82), rgba(26, 45, 90, 0.72)), url('https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80') center/cover no-repeat;
        ...
        .abt-number {
            ...
            width: 60px;
            height: 60px;
            background: linear-gradient(135deg, var(--primary), #0e40c7);
            color: white;
            border-radius: 50%;
            text-align: center;
            line-height: 60px;
        ...
        .feature-box:hover {
            ...
            box-shadow: 0 8px 25px rgba(22,82,240,0.12);
        }
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="abt-us-write">
                        ...
                        <br />
                        <p class="t-p">
                            PrimeAssetsTRD is founded with vision to create 100% transparent digital trading experience for its clients.
                        </p>
                        <br />
                        <p class="t-p">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-sm-12">
                    ...
                    <p class="t-p text-center">
                        PrimeAssetsTRD is an Optimal Wealth Management Company with emphasis on Wealth Management, Wealth Creation, Trades and Digital Assets usage. We offer various insured services capable of generating and returning good profit yield on crypto assets in the Blockchain through trading on a wide range of Instrument Categories. PrimeAssetsTRD has qualified financiers/traders that manage and provide financial consulting services to her investors. We pride ourselves with a world class professional customer service, unique trading strategies, optimum transparency and fidelity. Funds Invested with PrimeAssetsTRD can be Withdrawn, Transferred or Reinvested at will.
                    </p>
                </div>
            </div>
        </div>
