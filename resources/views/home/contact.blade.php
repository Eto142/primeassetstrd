...
<head>
    ...
    <title>Contact Us | PrimeAssetsTRD</title>
    ...
    <style>
        ...
        * {
        ...
        .contact-hero {
            background: linear-gradient(rgba(15, 28, 63, 0.82), rgba(26, 45, 90, 0.72)), url('https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80') center/cover no-repeat;
    ...
    <section class="section" style="padding-top: 0;">
        <div class="container">
            <div class="contact-form-container">
                ...
                <div style="border-radius: 10px; overflow: hidden; height: 400px; background: #f0f4ff; display: flex; align-items: center; justify-content: center;">
