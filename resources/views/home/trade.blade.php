...
<head>
    ...
    <title>Live Trading | PrimeAssetsTRD</title>
    ...
    <style>
        ...
        * {
        ...
        /* Trade Hero Section */
        .trade-hero {
            background: linear-gradient(rgba(15, 28, 63, 0.82), rgba(26, 45, 90, 0.72)), url('https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80') center/cover no-repeat;
