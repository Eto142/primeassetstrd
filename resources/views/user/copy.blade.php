...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between animate__animated animate__fadeInDown">
                        <h4 class="mb-sm-0 font-size-18">Copy Trading &mdash; Expert Traders</h4>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="card" style="background:rgba(0,200,150,0.05); border:1px solid rgba(0,200,150,0.2);">
                        <div class="card-body py-2">
                            <div class="d-flex align-items-center">
                                <span class="badge me-3" style="background:#00c896; color:#06101e; font-size:0.78rem; font-weight:700; padding:5px 10px;">
                                    <i class="fas fa-signal me-1"></i> LIVE
                                </span>
                                <div class="marquee-container" style="overflow: hidden; white-space: nowrap; flex:1;">
                                    <div class="marquee-content">
                                        <span class="text-muted" style="font-size:0.88rem;">📊 Browse verified expert traders with proven performance. Copy their trades automatically and share in their profits — commission only charged on gains.</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card trader-card h-100 trader-card-pro animate__animated animate__fadeInUp">
                        <div class="card-body">
                            <!-- Verified Badge -->
                            ...
                            <div class="text-center mb-3">
                                <a href="{{asset('uploads/trader/'.$trader->image)}}" class="glightbox">
                                    <img src="{{asset('uploads/trader/'.$trader->image)}}" class="trader-avatar pulse-effect" alt="{{$trader->name}}">
                                </a>
                            </div>
                            ...
                            <button id="copyButton{{$trader->id}}" 
                                ...
                                <i class="fas fa-copy me-1"></i> Copy Trader
                            </button>
                            ...
                            <div class="stats-container">
                                ...
                                <div class="stat-item">
                                    ...
                                    <div class="stat-label">12M Gains</div>
                                </div>
                                <div class="stat-item">
...
<style>
    ...
    .trader-card-pro:hover::before {
        left: 100%;
    }

    .trader-card-pro:hover {
    ...
    .trader-card-pro:hover .trader-avatar {
        border-color: #4361ee;
...
<script>
    ...
    function handleCopy(traderId, traderName) {
        ...
        // Add loading state
        button.innerHTML = '<i class="fas fa-copy me-1"></i> AI Processing...';
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                button.innerHTML = '<i class="fas fa-copy me-1"></i> AI Copy Again';
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const traderCards = document.querySelectorAll('.trader-card-pro');
        ...
        setInterval(() => {
            const badges = document.querySelectorAll('.pulse-effect');
