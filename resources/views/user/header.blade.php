...
<!-- Mirrored from themesbrand.com/PrimeAssetsTRD/layouts/{{route('user.home')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Nov 2025 21:17:32 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Dashboard | PrimeAssetsTRD - user dashboard</title>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="{{route('user.home')}}" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="logo.png" alt="" height="24"> <span class="logo-txt">PrimeAssetsTRD</span>
                                </span>
                            </a>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <div class="card sidebar-alert shadow-none text-center mx-4 mb-0 mt-5">
                            <div class="card-body">
                                ...
                                <div class="mt-4">
                                    <h5 class="alertcard-title font-size-16">Welcome to PrimeAssetsTRD</h5>
