                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> Â© PrimeAssetsTRD.
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    PrimeAssetsTRD <a href="#!" class="text-decoration-underline">trade</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from themesbrand.com/PrimeAssetsTRD/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Nov 2025 21:20:05 GMT -->
</html>
